import 'package:classes_app/firebase_options.dart';
...
void main() async {
  ...
  SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
    statusBarColor: ColorsInt.colorPrimary,
  ));
  runApp(MyApp(
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void navigationPage() {
    ...
    // if (sharedPrefs != null) {
    //   if (sharedPrefs.getBool(BaseURL.KEY_IS_LOGIN) &&
  ...
  //   OneSignal.shared.setAppId(BaseURL.ONESIGNAL_KEY);
