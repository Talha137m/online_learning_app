...
class BodyExams extends StatelessWidget {
  BodyExams(
      ...
      required this.offlineExamModelList,
      required this.onlineExamModelList,
    ...
    return new ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        if (examModel.attempt_id != null && examModel.attempt_id!.isNotEmpty) {
          if (double.parse(examModel.final_marks ?? "0") >=
              double.parse(examModel.exam_passing_marks ?? "0")) {
            examStatus = 1;
          }
        }
        return new Column(
          ...
          children: <Widget>[
            ...
            new Row(
              ...
              children: <Widget>[
                new Text(
                  DateFormatter.getConvetedDate(examModel.exam_date.toString(), 4),
                  style: TextStyle(
                ...
                new Text(
                  DateFormatter.getConvetedTime(
                          context, examModel.exam_start_time.toString(), 1)
                      .toUpperCase(),
                  style: TextStyle(
                      color: ColorsInt.colorBlack,
                      fontSize: 16.0,
                      ...
                      new Visibility(
                        ...
                        child: new Column(
                          ...
                          children: <Widget>[
                            new Text(
                              (pageStoreKey == "1")
                                  ? "${(double.parse(examModel.total_obtain_marks ?? "0") * 100 / double.parse(examModel.total_marks!)).toStringAsFixed(1)}%"
