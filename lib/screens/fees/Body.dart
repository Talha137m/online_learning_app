...
class Body extends StatelessWidget {
  Body(
      ...
      required this.total_remaining_amount,
      required this.feesModelListHistory,
      required this.feesModelList,
        ...
        new Container(
          ...
          child: new Column(
            ...
            children: <Widget>[
              ...
              new Text(
                "${total_remaining_amount ?? ""} ${BaseURL.CURRENCY}"
                    .toUpperCase(),
                style: TextStyle(
                    fontSize: 25.0,
                    fontFamily: "regular",
          ...
          child: new Container(
            ...
            child: new Row(
              ...
              children: <Widget>[
                ...
                new Text(
                  "${feesModel.paid_amount} ${BaseURL.CURRENCY}".toUpperCase(),
                  style: TextStyle(
                    fontFamily: "bold",
                    fontSize: 18.0,
                    color: ColorsInt.colorText,
          ...
          child: new Container(
            ...
            child: new Row(
              ...
              children: <Widget>[
                ...
                new Text(
                  "${feesModel.amount} ${BaseURL.CURRENCY}".toUpperCase(),
                  style: TextStyle(
                    fontFamily: "bold",
                    fontSize: 18.0,
                    color: ColorsInt.colorText,
