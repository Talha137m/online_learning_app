...
class BodyExamStart extends StatelessWidget {
  BodyExamStart(
      ...
      required this.examQuestionModelList,
      required this.currentQuestionPosition,
      required this.currentExamQuestionModel,
        ...
        new Expanded(
          child: new ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              bool isSelected =
                  (currentExamQuestionModel!.selectedIds != null &&
