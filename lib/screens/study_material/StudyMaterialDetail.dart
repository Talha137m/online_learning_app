...
import 'package:permission_handler/permission_handler.dart' as parm;
...
class _StudyMaterialDetailState extends State<StudyMaterialDetail> {
      ...
      String? youtubeid =
          ((showVideo && (videoType.isNotEmpty && videoType == "youtube")) &&
              ...
              ? YoutubePlayer.convertUrlToId(
                  _studyMaterialModel.video_url.toString())
              : "test video";

      _youtubePlayerController = YoutubePlayerController(
        initialVideoId: youtubeid.toString(),
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => ViewDocument(
                      fileUrl: finalUrl,
                      title: widget.studyMaterialModel.title.toString(),
                    )));
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return new WillPopScope(
        ...
        child: (showVideo && (videoType.isNotEmpty && videoType == "youtube"))
            ? _youtubeView()
            : _commonView());
  }
  ...
  Widget _commonView() {
    return new Scaffold(
      ...
      appBar: new AppBar(
        title:
            new Text(AppLocalizations.of(context).translate("study_material")),
  ...
  Future<bool> _checkPermission() async {
    return await parm.Permission.storage.request().isGranted;
  }
