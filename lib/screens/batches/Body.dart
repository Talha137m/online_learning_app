...
class Body extends StatelessWidget {
  Body({Key? key, required this.batchModelList}) : super(key: key);
                          ...
                          child: new Column(
                            ...
                            children: <Widget>[
                              FittedBox(
                                fit: BoxFit.fitWidth,
                                child: new Text(
                                  "${DateFormatter.getConvetedTime(context, batchModel.start_time.toString(), 1)} - ${DateFormatter.getConvetedTime(context, batchModel.end_time.toString(), 1)}",
                                  style: TextStyle(
                                    fontFamily: "bold",
                                    fontSize: 14.0,
                                    color: ColorsInt.colorBlack,
