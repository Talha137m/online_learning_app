...
class BodyAnnouncement extends StatelessWidget {
  BodyAnnouncement({Key? key, required this.announcementModelList})
      : super(key: key);
                    ...
                    child: new ClipRRect(
                      ...
                      child: new Hero(
                        ...
                        child: new Image.network(
                          BaseURL.IMG_ANNOUNCEMENT +
                              announcementModel.image.toString(),
                          fit: BoxFit.cover,
                          height: 150.0,
                          width: double.infinity,
                        ),
                        ...
                        children: <Widget>[
                          ...
                          new Text(
                            DateFormatter.getConvetedDateTime(
                                context, announcementModel.created_at.toString(), 1),
                            style: TextStyle(
                                fontFamily: "regular",
                                fontSize: 10.0,
