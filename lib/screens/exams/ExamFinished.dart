...
class _ExamFinishedState extends State<ExamFinished> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      _totalCurrectAnswer = widget.examModel!.total_correct.toString();
      _totalWrongAnswer = widget.examModel!.total_wrong.toString();
      _totalSkipedAnswer = widget.examModel!.total_skip.toString();
    });
  }
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new BodyExamFinished(
        totalSpendSeconds: widget.totalSpendSeconds ?? 0,
