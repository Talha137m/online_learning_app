...
class ExamModel {
  ...
  ExamModel({
    ...
    required this.batch_ids,
    required this.exam_title,
    required this.exam_description,
    required this.exam_total_marks,
    required this.exam_passing_marks,
    required this.exam_correct_ans_marks,
    required this.exam_incorrect_ans_marks,
    required this.exam_date,
    required this.exam_total_time,
    required this.exam_start_time,
    required this.exam_type,
    required this.exam_on_schedule,
    required this.exam_schedule_min,
    required this.batches_name,
  ...
  factory ExamModel.fromJson(Map<String, dynamic> json) {
    return ExamModel(
      ...
      batch_ids: json['batch_ids'].toString(),
